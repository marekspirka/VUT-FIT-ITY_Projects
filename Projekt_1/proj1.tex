% Projekt : ITY Projekt 1 - typografie a publikovanie
...
\begin{quotation}
    ...
    písma a~jiných \textsc{\color{red}efektů} \underline{použijeme}, tím \textcolor{orange}{profesionálněji} bude {\fontfamily{pzc}\selectfont \Large{dokument}} vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
\end{quotation}
